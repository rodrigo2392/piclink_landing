...
export const AnimatedTestimonials = ({
  ...
  return (
    <section className="lg:py-16 lg:px-4  z-40">
      <div className="mx-auto max-w-screen-md text-center lg:mb-4">
        ...
        <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
          Esto es lo que opinan los profesionales de nuestra plataforma.
        </p>
      </div>
      <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-6 md:py-20">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
          ...
          <div className="flex justify-between flex-col md:py-4">
            ...
            <div className="flex gap-4 pt-12 justify-center md:pt-0">
              <button
                onClick={handlePrev}
